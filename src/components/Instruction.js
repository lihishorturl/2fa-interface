...
const steps = [
  { name: '1. Get your 2FA key from service provider, ex. Binance, Cloudflare, FTX and etc', href: '#', status: 'complete' },
  { name: '2. Click on mint a lihi Authenticator', href: '#', status: 'current' },
  { name: '3. Enter provider info', href: '#', status: 'upcoming' },
  { name: '4. You are all set!', href: '#', status: 'upcoming' },
]
